...
class Main_Hero(Graphic_elements):
    def __init__(self,x,y,width,height,path,SCREEN_W,SCREEN_H,where_move,count_move, win):
        ...
        self.count_step = 99# Количество шагов
    ...
    def move_sprite(self, mat_objetcs, LENGTH_MAP,resources_dict,recourse_sounds,list_cor_portals,move_to_hero,CENTER_CELL_COR,list_cor_player_xy,list_objects_cells_lvl1,SCREEN_W,SCREEN_H):
        ...
        if self.count_step != 0:
            ...
            elif self.player_cor[0] != LENGTH_MAP-1:
                if mat_objetcs[self.player_cor[0]+1][self.player_cor[1] ]  in list_symbols_biuldings: 
                    self.near_building = True
                    building_cor = mat_objetcs[self.player_cor[0]+1][self.player_cor[1]]
                else:
                    building_cor = None
